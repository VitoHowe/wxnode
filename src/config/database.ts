  ...
  try {
    ...
    await connection.execute(`
      CREATE TABLE IF NOT EXISTS user_word_progress (
        ...
        UNIQUE KEY uk_user_word (user_id, word_entry_id),
        ...
        CONSTRAINT fk_word_progress_book FOREIGN KEY (book_id) REFERENCES word_books(id) ON DELETE CASCADE,
        CONSTRAINT fk_word_progress_entry FOREIGN KEY (word_entry_id) REFERENCES word_book_entries(id) ON DELETE CASCADE
      ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
    `);
    ...
    await connection.execute(`
      CREATE TABLE IF NOT EXISTS user_word_book_state (
        ...
        created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
        updated_at DATETIME DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
        UNIQUE KEY uk_user_book_state (user_id, book_id),
        KEY idx_state_user_book (user_id, book_id),
        CONSTRAINT fk_word_state_user FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
        CONSTRAINT fk_word_state_book FOREIGN KEY (book_id) REFERENCES word_books(id) ON DELETE CASCADE,
        CONSTRAINT fk_word_state_entry FOREIGN KEY (last_word_entry_id) REFERENCES word_book_entries(id) ON DELETE SET NULL
      ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
    `);
